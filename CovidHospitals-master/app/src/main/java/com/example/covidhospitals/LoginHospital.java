                ...
                .addOnCompleteListener(new OnCompleteListener<Boolean>() {
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        if (task.isSuccessful()) {
                            ...
                            db.collection("controlroom").document("CJajYPSnVveSHYoQ3Zhj")
                                    .update(
        ...
        db.collection("controlroom").document(docId).get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull @NotNull Task<DocumentSnapshot> task) {
                        ...
                        Log.i("pass","my name isk han");

                        //if (task.getResult().exists()){
                            Toast.makeText(getApplicationContext(),"I am the best in the owrld",Toast.LENGTH_SHORT).show();
                            String enterPwd = task.getResult().getString("pwd");
                            Log.d("tag1", "pwd : " + enterPwd);
